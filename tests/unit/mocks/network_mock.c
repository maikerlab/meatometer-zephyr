...
static bool mock_is_connected(void) { return mock_connected; }

static bool mock_has_credentials(void) { return mock_has_creds; }
...
const network_iface_t *network_mock_get_iface(void) { return &mock_iface; }
...
void network_mock_set_has_credentials(bool value) { mock_has_creds = value; }

bool network_mock_connect_stored_called(void) { return connect_stored_called; }

bool network_mock_connect_called(void) { return connect_called; }

bool network_mock_disconnect_called(void) { return disconnect_called; }
