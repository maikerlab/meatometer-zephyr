...
const mqtt_iface_t *mqtt_mock_get_iface(void) { return &mock_iface; }
...
bool mqtt_mock_is_initialized(void) { return mock_initialized; }
bool mqtt_mock_is_connected(void) { return mock_connected; }
float mqtt_mock_last_published_temp(void) { return last_published_temp; }