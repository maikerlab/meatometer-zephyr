...
static const struct smf_state states[] = {
    [ST_PROVISIONING] = SMF_CREATE_STATE(
        state_provisioning_entry, state_provisioning_run, NULL, NULL, NULL),
    [ST_WIFI_CONNECTING] =
        SMF_CREATE_STATE(state_wifi_connecting_entry, state_wifi_connecting_run,
                         NULL, NULL, NULL),
    [ST_MQTT_CONNECTING] =
        SMF_CREATE_STATE(state_mqtt_connecting_entry, state_mqtt_connecting_run,
                         NULL, NULL, NULL),
    [ST_ONLINE] = SMF_CREATE_STATE(state_online_entry, state_online_run, NULL,
                                   NULL, NULL),
};
...
bool conn_fsm_is_online(void) { return atomic_load(&online_flag) != 0; }
